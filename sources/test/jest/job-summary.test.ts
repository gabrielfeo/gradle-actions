                ...
                expect(table.trim()).toBe(dedent`
                    <table>
                        ...
                        <tr>
                            ...
                            <td align='center'>8.0</td>
                            <td align='center'>:white_check_mark:</td>
                            <td><a href="https://scans.gradle.com" rel="nofollow" target="_blank"><img src="https://img.shields.io/badge/Build%20Scan%C2%AE-lightgrey?logo=Gradle" alt="Build Scan not published" /></a></td>
                        </tr>
                    </table>
                `);
            })
                ...
                expect(table.trim()).toBe(dedent`
                    <table>
                        ...
                        <tr>
                            ...
                            <td align='center'>8.0</td>
                            <td align='center'>:white_check_mark:</td>
                            <td><a href="https://docs.gradle.com/develocity/gradle-plugin/#troubleshooting" rel="nofollow" target="_blank"><img src="https://img.shields.io/badge/Build%20Scan%C2%AE-orange?logo=Gradle" alt="Build Scan publish failed" /></a></td>
                        </tr>
                    </table>
                `);
            })
